...
//    	
	...
	public static String findAuthResultDesc(String authCode) {
		...
		}else if(faceCode.matches("[C]")){
			desc = ErrorCodeConstants.AUTH_FACE_DATA_MESSAGE;
		}else if(faceCode.matches("[D]")){
			desc = ErrorCodeConstants.AUTH_FACE_NOPIC_MESSAGE;
		}else if(faceCode.matches("[E]")){
			desc = ErrorCodeConstants.AUTH_FACE_TYPE_MESSAGE;
		}else if(faceCode.matches("[F,G,J]")){
			desc = ErrorCodeConstants.AUTH_FACE_QUALITY_MESSAGE;
		}else{
