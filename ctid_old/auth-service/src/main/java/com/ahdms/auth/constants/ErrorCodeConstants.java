...
public class ErrorCodeConstants {
	...
	//网证开通手机验证码 相关错误码
	public static final int DOWN_SMSCODE_DEFAULT_CODE = 0x00A19500;
	public static final String DOWN_SMSCODE_DEFAULT_MESSAGE = "网证下载失败";

	public static final int DOWN_SMSCODE_EXPIRE_CODE = 0x00A19501;
	public static final String DOWN_SMSCODE_EXPIRE_MESSAGE = "短信验证码已失效";

	public static final int DOWN_SMSCODE_CANCEL_CODE = 0x00A19502;
	public static final String DOWN_SMSCODE_CANCEL_MESSAGE = "短信验证码填写错误";

	public static final int DOWN_SMSCODE_SEND_CODE = 0x00A19503;
	public static final String DOWN_SMSCODE_SEND_MESSAGE = "发送短信验证码失败";

	public static final int DOWN_SMSCODE_COUNT_CODE = 0x00A19504;
	public static final String DOWN_SMSCODE_COUNT_MESSAGE = "当日短信条数已达限制";

	public static final int DOWN_SMSCODE_MOBILE_CODE = 0x00A19505;
	public static final String DOWN_SMSCODE_MOBILE_MESSAGE = "手机号格式不正确";

	public static final int DOWN_SMSCODE_BSN_CODE = 0x00A19506;
	public static final String DOWN_SMSCODE_BSN_MESSAGE = "业务流水号与模式不匹配";

	public static final int DOWN_SMSCODE_REPEAT_CODE = 0x00A19507;
	public static final String DOWN_SMSCODE_NONE_MESSAGE = "不许重复提交请求(一分钟后重新获取短信验证码)";

	public static final int DOWN_SMSCODE_ERROR_CODE = 0x00A19508;
	public static final String DOWN_SMSCODE_ERROR_MESSAGE = "网证开通系统异常";

	public static final int DOWN_SMSCODE_BSNEXPIRE_CODE = 0x00A19509;
	public static final String DOWN_SMSCODE_BSNEXPIRE_MESSAGE = "业务流水号已失效";
