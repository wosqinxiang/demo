/**
 * Created on 2020年2月11日 by LUOTAO
 */
...
public class ExcelUtilTest {
    ...
    public static void main(String[] args) {
        List<List<String>> resultList = ExcelUtilTest.readExcel("E:/home/template.xls");
        if (resultList != null) {
        ...
        //把读取的结果在写回去
        ExcelUtilTest.writeExcel(resultList, "E:/home/result.xls");
    }
