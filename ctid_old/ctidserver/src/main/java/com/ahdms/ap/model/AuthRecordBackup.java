...
public class AuthRecordBackup {
	...
	public AuthRecordBackup() {
		super();
		// TODO Auto-generated constructor stub
	}

	public AuthRecordBackup(String id, Integer infoSource, String name, String idcard, Integer authType, Integer ctidType,
			Integer authResult, String serverAccount, Date createTime, String serialNum, String pic, String signData,String openid,String location) {
		super();
		this.id = id;
		this.infoSource = infoSource;
		this.name = name;
