...
//        // 先找方法，再找方法上的类
//        A com.ahdms.framework.lock.annotation = handlerMethod.getMethodAnnotation(annotationType);
//        if (null != com.ahdms.framework.lock.annotation) {
//            return com.ahdms.framework.lock.annotation;
//        }
//        // 获取类上面的Annotation，可能包含组合注解，故采用spring的工具类
