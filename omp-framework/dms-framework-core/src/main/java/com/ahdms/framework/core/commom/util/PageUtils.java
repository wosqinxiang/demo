...
import com.ahdms.framework.core.commom.page.PageParam;
...
public class PageUtils {
    ...
    public static <T> Page<T> toPage(IPage<?> page, Class<T> target) {
        ...
        pageResult.setRecords(BeanUtils.copy(page.getRecords(), target));
        return pageResult;
    }
     ...
     * @see {@link #toPageResult(com.baomidou.mybatisplus.core.metadata.IPage, Function)}
     */
