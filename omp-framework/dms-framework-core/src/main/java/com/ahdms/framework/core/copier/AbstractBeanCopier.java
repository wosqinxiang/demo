...
public abstract class AbstractBeanCopier {
    ...
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor v) {
            ...
            PropertyDescriptor[] getters = com.ahdms.framework.core.commom.util.ReflectUtils.getBeanGetters(source);
            PropertyDescriptor[] setters = com.ahdms.framework.core.commom.util.ReflectUtils.getBeanSetters(target);
            ...
            for (PropertyDescriptor setter : setters) {
                ...
                CopyProperty targetIgnoreCopy = com.ahdms.framework.core.commom.util.ReflectUtils.getAnnotation(target, propName, CopyProperty.class);
                // set 上有忽略的 注解
