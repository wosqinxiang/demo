package com.ahdms.framework.mybatis.generate;

import com.ahdms.framework.core.commom.util.ExceptionsUtils;
...
//            buildClass("service.comp", "service-comp-impl.java", "ServiceCompImpl");
            ...
            buildClass("bean.vo", "entity-response.java", "RspVo");
...
//            || templateName.equals("dao-comp.java")
    ...
    public Map<String, Object> createRenderData(String tableName) {
        ...
        data.put("date", new SimpleDateFormat("yyyy-MM-dd HH:ss").format(new Date()));
